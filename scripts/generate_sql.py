...
def get_sequence(val):
    try:
        # Strip any non-numeric characters if needed
...
def process_data():
    ...
    print("Processing CSV with Chronological Sequence Logic (Column K)...")
    with open(CSV_PATH, 'r', encoding='utf-8') as f:
        ...
        for i, row in enumerate(reader):
            ...
            row_data = {
                ...
                'note': note,
                'row_idx': i # Tie-breaker for sorting
            }
    ...
    for bin_num, rows in bins_history.items():
        # Chronological Sort: Date -> Sequence -> Row Index
        ...
        # Final status is based on the LAST row in the driver's sequence
    ...
    with open(OUTPUT_SQL, 'w', encoding='utf-8') as sql:
        sql.write("-- Generated with Chronological Sequence Logic (Column K)\nBEGIN;\n\n")
        ...
        sql.write("COMMIT;\n")
    print(f"Final SQL generated using Sequence Numbers at {OUTPUT_SQL}")
